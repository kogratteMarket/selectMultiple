        ...
        selectMultiple : function (options) {
            ...
            $(this).each(function () {
                ...
                $('*', originalSelect).each(function () {
                    var $_originalSelectItem = $(this),
                        $_originalSelectItemIsSelected,
                        $_originalSelectItemName,
                    ...
                    switch ($_originalSelectItem[0].nodeName) {
                        case 'OPTION':
                            ...
                            checkbox = $(document.createElement('input')).attr({
                                ...
                                'name'     : $_originalSelectItemName && ($_originalSelectItemName !== undefined) ? $_originalSelectItemName : originalSelectName,
